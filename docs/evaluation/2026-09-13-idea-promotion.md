...
Migration 0026 adds two operational tables. Preparation creates a retained intent
...
Migration 0026 is additive and authorized by the requested explicit-promotion scope.
...
The only migration in this PR remains additive 0026; no world-history, birth pin,
